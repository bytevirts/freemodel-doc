...
`gpt-image-2-all` is the alternate GPT Image 2 serving route. A successful 1K generation costs **$0.02**, equal to **2 FreeModel credits**.
...
<Card title="Open the model playground" icon="wand-magic-sparkles" href="https://freemodel.app/models/gpt-image-2-all">
