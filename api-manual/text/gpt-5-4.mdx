---
title: "GPT-5.4"
description: "Call the gpt-5.4 text model through FreeModel-compatible text protocols."
api: "POST /v1/chat/completions"
---

Use `gpt-5.4` for OpenAI-compatible chat and streaming workloads. The same model ID also works with FreeModel's Responses, Anthropic Messages, and Gemini native compatibility routes.
...
<Note>
  ...
  gateway. Confirm live rates on the [models page](https://freemodel.app/models).
</Note>
