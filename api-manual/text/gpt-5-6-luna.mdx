---
title: "GPT-5.6 Luna"
description: "Use the lowest-priced GPT-5.6 route on FreeModel."
api: "POST /v1/chat/completions"
---

`gpt-5.6-luna` is the lowest-priced GPT-5.6 route in the current FreeModel catalog. Treat it as a distinct model ID when setting limits, monitoring usage, and comparing output quality.
...
<Tip>
  ...
  FreeModel does not alias it to another GPT-5.6 route.
</Tip>
