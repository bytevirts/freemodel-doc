...
FreeModel uses prepaid USD balance with no subscription. Text routes are token-billed. GPT Image 2 and video routes use fixed or duration-based request prices.
