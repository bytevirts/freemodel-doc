...
<ParamField body="n" type="integer" default="1">
  Request one image. The current FreeModel image routes do not support batch
  generation.
</ParamField>
...
<Note>
  GPT Image 1 and 1.5 are token-billed. GPT Image 2 routes are billed per
  successful generation. See the individual model page before estimating cost.
</Note>
