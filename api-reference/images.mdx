...
<ParamField body="size" type="string">
  `1024x1024` creates a 1:1 image. `1536x1024` creates a 3:2 image.
  `1024x1536` creates a 2:3 image. Omit this field, or use another value, to
  use the automatic aspect ratio.
</ParamField>
