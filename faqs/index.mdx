...
Use these topic pages to diagnose the most common FreeModel integration questions.
...
<CardGroup cols={2}>
  ...
  <Card title="Live pricing" icon="chart-line" href="https://freemodel.app/models">
